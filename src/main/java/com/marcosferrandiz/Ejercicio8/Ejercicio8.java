...
import com.marcosferrandiz.Ejercicio7.Ejercicio7;
...
public class Ejercicio8 {
     ...
     */
    public static void detonadorDeExcepciones(int[] array, int num){
        int resultadoDivi;
        int contador = 0;
        ...
        try{
            if (array.equals(null)) {
                ...
                while (!valido){
                    try{
                        array[contador] = SolicitarCosas.solicitarEntero("Escriba el numero a ingresar [1 - 50]",1,50);
                        ...
                        throw new IndexOutOfBoundsException("Te has pasado del limite del array");
                    }
                }
            }
